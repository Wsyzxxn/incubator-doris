...
# JSONCPP
JSONCPP_DOWNLOAD="https://codeload.github.com/open-source-parsers/jsoncpp/zip/0.y.z"
JSONCPP_NAME=jsoncpp-0.y.z.zip 
JSONCPP_SOURCE=jsoncpp-0.y.z
JSONCPP_MD5SUM="28a80e9c5ff3cd82e7aa762f4ba8a8b1"

# AVRO
AVRO_DOWNLOAD="https://github.com/songenjie/incubator-doris/tree/0.11.16-master/thirdparty/avro-1.8.0.tar.gz"
AVRO_NAME=avro-1.8.0.tar.gz
AVRO_SOURCE=avro-1.8.0
AVRO_MD5SUM="20b5447421c6bd0a1a92b2e1dbad5722"

# all thirdparties which need to be downloaded is set in array TP_ARCHIVES
export TP_ARCHIVES="LIBEVENT OPENSSL THRIFT LLVM CLANG COMPILER_RT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP LZO2 CURL RE2 BOOST MYSQL BOOST_FOR_MYSQL LEVELDB BRPC ROCKSDB LIBRDKAFKA ARROW BROTLI DOUBLE_CONVERSION URIPARSER ZSTD S2 BITSHUFFLE CROARINGBITMAP JSONCPP AVRO ORC"
